...
class workshopController extends Controller
{
    ...
    public function create($id)
    {
        ...
        $workshops = $this->getalistamientodetail($id, $dataWorkshop[0]->centrocosto_id);
    ...
    public function savedetail(Request $request)
    {
        try {
            ...
            $arraydetail = $this->getalistamientodetail($request->tallerId, $request->centrocosto);
    ...
    public function getalistamientodetail($tallerId, $centrocostoId)
    {
    ...
    public function sumTotales($id)
    {
        ...
        $kgTotalRequeridos = (float)workshop_detail::Where([['workshops_id', $id], ['status', 1]])->sum('kgrequeridos');
    ...
    public function add_shopping(Request $request)
    {
        try {
            ...
            $regProd = $this->getalistamientodetail($request->tallerId, $request->centrocosto);
            $count = count($regProd);
            if ($count == 0) {
                return response()->json([
                    'status' => 0,
