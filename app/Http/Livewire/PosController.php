...
class PosController extends Component
{
	...
	public $total, $itemsQuantity, $efectivo, $change, $status, $thirdid, $vendedor;
	...
	public function saveSale()
	{
		...
		try {
    		...
    		'thirdid' => 'required|not_in:Elegir'
    				
	    	];

	    	$messages = [
	    		
	    		'status.not_in' => 'Escoja el medio de pago',
	    		'thirdid.not_in' => 'Escoja la línea de Negocio'	    		
