...
class PrecioAgreementsController extends Component
{
	...
	public $line, $agreementid, $productid, $product_id, $precio, $vendedor,  $descuento, $valorfinal, $search, $selected_id, $pageTitle, $componentName;
    ...
    public function render()
    {
    	if (strlen($this->search) > 0)
			$precio_agreements = Precio_agreement::join('agreements as a', 'a.id', 'precio_agreements.agreement_id')
				...
				->select('precio_agreements.*', 't.name as type_identification',
						 'precio_agreements.*', 'o.name as office',
						 'precio_agreements.*', 'a.name as agreement')
			...
			$precio_agreements = Precio_agreement::join('agreements as a', 'a.id', 'precio_agreements.agreement_id')
				...
				->select('precio_agreements.*', 'a.name as agreement',						
						 'precio_agreements.*', 'u.name as user',
						 'precio_agreements.*', 'prod.name as product')
	    ...
	    return view('livewire.precio_agreements.component', ['data' => $precio_agreements,
