...
const btnAddFaster = document.querySelector("#btnAddFaster");
const formFaster = document.querySelector("#form-faster");
...
const faster_id = document.querySelector("#fasterId");
...
const showDataForm = (id) => {
    ...
    send(dataform, "/fasterById").then((resp) => {
        console.log(resp);
...
const showData = (resp) => {
    ...
    const modal = new bootstrap.Modal(
        document.getElementById("modal-create-faster")
    );
    modal.show();
};
...
const form = document.getElementById("fasterId");
...
const downFaster = (id) => {
    swal({
        ...
        if (result.value) {
            ...
            const dataform = new FormData();
            dataform.append("id", id);
            send(dataform, "/downmmainfaster").then((resp) => {
                console.log(resp);
                refresh_table();
            });
        }
...
const refresh_table = () => {
    let table = $("#tableFaster").dataTable();
    table.fnDraw(false);
};
