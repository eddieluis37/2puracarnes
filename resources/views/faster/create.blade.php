		...
		<div class="widget widget-chart-one">
							...
							<div class="col-md-4">
								<div class="task-header">
									<div class="form-group">
										...
										<input type="hidden" id="categoryId" name="categoryId" value="{{$dataFaster[0]->categoria_id}}">
										<p>{{$dataFaster[0]->namecategoria}}</p>
									</div>
								</div>
							</div>
							<div class="col-md-4">
								<div class="task-header">
									<div class="form-group">
										...
										<p>{{$dataFaster[0]->namecentrocosto}}</p>
									</div>
								</div>
							</div>
						</div>
			...
			<div class="widget-content mt-3" style="{{$display}}">
				<div class="card">
					<div class="card-body">
						<form id="form-detail">
						<input type="hidden" id="fasterId" name="fasterId" value="{{$dataFaster[0]->id}}">
						<div class="row g-3">
							<div class="col-md-4">
								<div class="task-header">
									<div class="form-group">
                                        <label for="" class="form-label">Buscar corte padre</label>
										<input type="hidden" id="meatcutId" name="meatcutId" value="{{$dataFaster[0]->meatcut_id}}">
										<input type="hidden" id="productopadreId" name="productopadreId" value="{{$cortes[0]->productopadreId}}">
										<input type="hidden" id="centrocosto" name="centrocosto" value="{{$dataFaster[0]->centrocosto_id}}">
							...
							<div class="col-md-2 text-center">
								...
								<div class="d-grid gap-2">
									<button id="btnAddFaster" class="btn btn-primary">Aceptar</button>
								</div>
								</div>
							</div>
						</div>
					...
					<div class="card-body">
						<div class="row">
							...
							<div class="col-md-4">
								...
								<div class="input-group flex-nowrap">
								<input type="text" id="newStockPadre" name="newStockPadre" value="{{$dataFaster[0]->nuevo_stock_padre}}" class="form-control-sm form-control" placeholder="30,00 kg" readonly>
									<span class="input-group-text" id="addon-wrapping">KG</span>
								</div>
							</div>
						</div>
                ...
                <div class="card">
                    <div class="card-body">
							<div class="table-responsive mt-3">
								<table id="tableFaster" class="table table-sm table-striped table-bordered">
									...
									<tfoot id="tabletfoot" >
										<tr>
											...
											<th class="text-center">
												@if($dataFaster[0]->inventario == 'pending')
...
@endsection
@section('script')
<script src="{{asset('code/js/faster/code-create.js')}}" type="module"></script>
@endsection