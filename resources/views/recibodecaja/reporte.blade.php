		...
		<table cellpadding="0" cellspacing="0" class="table-items" width="100%">
			...
			<tbody>
				...
				<tr>
					...
					<td align="center">$ {{number_format($sale[0]->saldo),2}}</td>
					<td align="center">$ {{number_format($sale[0]->abono),2}}</td>
					<td align="center">$ {{number_format($sale[0]->nuevo_saldo),2}}</td>
			...
			<tfoot>
				<tr>
					...
					<td class="text-center">
						<span><strong>$ {{ number_format($sale[0]->abono),2}}</strong></span>
					</td>
					<td class="text-center">
						<span><strong>$ {{ number_format($sale[0]->nuevo_saldo),2}}</strong></span>
					</td>
				</tr>
			</tfoot>
		</table>
