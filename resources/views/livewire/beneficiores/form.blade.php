                                    ...
                                    <div class="btn-toolbar justify-content-between">
                                            ...
                                            <div class="task-header">
                                                <div class="form-group">
                                                   <label>Planta Sacrificio</label>
                                                    <div>
                                                        <select class="form-control" name="plantasacrificio_id" id="plantasacrificio_id">
                                            ...
                                            <div class="task-header">
                                                <div class="form-group">
                                                   <label>Cantidad</label>                                                                                            
                                                        <input type="text" name="cantidad" id="cantidad" class="form-control" "aria-describedby="helpId">
                                        ...
                                        <div class="col-sm-12 col-md-4">                                
                                            <div class="task-header">
                                                <div class="form-group">
                                                   <label>Factura</label>                                                                                             
                                                        <input type="text" class="form-control" name="factura" id="factura" placeholder="ej: PCD789" >
                                                        @error('cantidad') <span class="text-danger er">{{ $message}}</span>@enderror
                                                </div>                                                  
                                            </div>
                                        </div>                                    
                                            ...
                                            <div class="task-header">
                                                <div class="form-group">
                                                   <label>Cliente Pielees</label>
                                                        <select class="form-control" name="clientpielesid" id="clientpielesid">                 
                                                            <option value="">Seleccione el proveedor</option>
                                                            @foreach ($thirds as $p)
                                                            <option value="{{$p->id}}">{{$p->name}}</option>
                                                            @endforeach
                                            ...
                                            <div class="task-header">
                                                <div class="form-group">
                                                   <label>Cliente visceras</label>
                                                        <select class="form-control" name="clientviscerasid" id="clientviscerasid">            
                                                            <option value="">Seleccione el proveedor</option>
                                                            @foreach ($thirds as $p)
                                                            <option value="{{$p->id}}">{{$p->name}}</option>
                                                            @endforeach
                                        ...
                                        <div class="col-sm-12 col-md-4">                                
                                            <div class="task-header">
                                                <div class="form-group">
                                                   <label>Lote</label>                                                                                            
                                                        <input type="text" class="form-control" name="lote" id="lote" placeholder="ej: PCD789" >
                                            ...
                                            <div class="card-body">
                                                <div class="form-row">
                                                    <div class="form-group col-sm">
                                                        ...
                                                        <input type="text" name="pesopie1" id="pesopie1" class="form-control" aria-describedby="helpId" step="0.01" required>
                                                    </div>

                                                    <div class="form-group col-sm">
                                                        <label for="sell_price">Costo Animal 1</label>
                                                        <input type="text" name="costoanimal1" id="costoanimal1" class="form-control" aria-describedby="helpId" step="0.01" required>
                                                    </div>
                                        ...
                                        <div class="card-body">
                                            <div class="form-row">
                                                <div class="form-group col-sm">
                                                    ...
                                                    <input type="text" name="pesopie2" id="pesopie2" class="form-control" aria-describedby="helpId" step="0.01">
                                                </div>

                                                <div class="form-group col-sm">
                                                    <label for="sell_price">Costo Animal 2</label>
                                                    <input type="text" name="costoanimal2" id="costoanimal2" class="form-control" aria-describedby="helpId" step="0.01">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-body">
                                            <div class="form-row">
                                                <div class="form-group col-sm">
                                                    ...
                                                    <input type="text" name="pesopie3" id="pesopie3" class="form-control" aria-describedby="helpId" step="0.01">
                                                </div>

                                                <div class="form-group col-sm">
                                                    <label for="sell_price">Costo Animal 3</label>
                                                    <input type="text" name="costoanimal3" id="costoanimal3" class="form-control" aria-describedby="helpId" step="0.01">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-row mt-3">
                                    <div class="form-group col-md-2">
                                        ...
                                        <input type="text" name="canalcaliente" id="canalcaliente" class="form-control" aria-describedby="helpId" step="0.01">
                                    </div>
                                    <div class="form-group col-md-2">
                                    ...
                                    <div class="form-group col-md-2">
                                        ...
                                        <input type="text" name="canalplanta" id="canalplanta" class="form-control" aria-describedby="helpId" step="0.01">
                                    </div>
                                    <div class="form-group col-md-2">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-row">                                
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="costokilo" name="tsacrificio" id="tsacrificio" class="form-control" aria-describedby="helpId" readonly step="0.01">
                                </div>
                                <div class="form-group col-md-4">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="costokilo" name="ttransporte" id="ttransporte" class="form-control" aria-describedby="helpId" readonly step="0.01">
                                </div>
                                <div class="form-group col-md-4">
