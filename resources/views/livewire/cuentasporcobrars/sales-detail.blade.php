          ...
          <table class="table table-bordered table striped mt-1">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class='text-center'><h6>{{number_format($d->price)}}</h6></td>
                <td class='text-center'><h6>{{number_format($d->quantity,1)}}</h6></td>
                <td class='text-center'><h6>{{number_format($d->price * $d->quantity)}}</h6></td>               
