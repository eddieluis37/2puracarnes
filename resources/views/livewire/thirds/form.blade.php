...
<div class="col-sm-12 col-md-8">
	<div class="form-group">
		...
		class="form-control product-name" placeholder="ej: Nombre del cliente o proveedor" autofocus >
...
<div class="col-sm-12 col-md-4">
	<div class="form-group">
		...
		<input type="text" wire:model.lazy="identification" 
		class="form-control"
		{{ $selected_id > 0 ? 'disabled' : '' }} 		
		placeholder="ej: 1018478965" >
...
<div class="col-sm-12 col-md-4">
	<div class="form-group">
		<label >Email</label>
		<input type="text" wire:model.lazy="correo" 
		class="form-control" placeholder="ej: luis.gonzalez@gmail.com"  >
