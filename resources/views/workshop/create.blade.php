					...
					<div class="card-body">
						<div class="row">
							...
							<div class="col-md-4">
								...
								<div class="input-group flex-nowrap">
								<input type="text" id="newStockPadre" name="newStockPadre" value="{{$dataWorkshop[0]->nuevo_stock_padre}}" class="form-control-sm form-control" placeholder="30,00 kg" readonly>
									<span class="input-group-text" id="addon-wrapping">KG</span>
								</div>
							</div>
						</div>
									...
									<tfoot id="tabletfoot" >
										<tr>
											...
											<th class="text-center">
												@if($dataWorkshop[0]->inventario == 'pending')
