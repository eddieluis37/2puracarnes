					...
					<table id="tableCompensado" class="table table-striped mt-1">
						<thead class="text-white" style="background: #3B3F5C">
							<tr>
								...
								<th class="table-th text-white ">RESOL.ND</th>
								<th class="table-th text-white">ESTADO</th>
								<th class="table-th text-white">TIPO</th>
								<th class="table-th text-white">VALOR.ND</th>
...
@endsection
@section('script')
<script src="{{asset('rogercode/js/notadebito/rogercode-notadebito-index.js')}}"></script>
<script src="{{asset('rogercode/js/notadebito/rogercode-create-update.js')}}" type="module"></script>
@endsection